...
JQ_AUTO_AUDIT_TOKEN = 'etf_factor_rotation-gold-crowd-ab-gold-calc-longwin-20260515205636-32812db8'
...
def set_parameter(context):
    ...
    g.CrowdStart_by_etf = None
    g.CrowdEnd_by_etf = None
    g.MinCrowdPenalty_by_etf = None
    g.CrowdRetShort_by_etf = [20, 20, 40]
    g.CrowdRetMid_by_etf = [60, 60, 90]
