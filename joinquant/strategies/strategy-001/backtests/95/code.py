...
JQ_AUTO_AUDIT_TOKEN = 'etf_factor_rotation-s01-fixed-daily-deviation-20260619194437-d8244585'
...
def execute_live_like_rebalance(context):
    ...
    queue.pop(0)
def daily_deviation_rebalance(context):
    params = snapshot_params()
    plan = build_rebalance_plan(context)
    target_weights = plan["final_weights"]
    pool = plan["pool"]
