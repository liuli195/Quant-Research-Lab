...
JQ_AUTO_AUDIT_TOKEN = 'etf_factor_rotation-gold-crowd-ab-gold-start-080-20260515205119-43936200'
...
def set_parameter(context):
    ...
    g.CrowdStart_by_etf = [0.6, 0.6, 0.8]
    g.CrowdEnd_by_etf = [0.95, 0.95, 0.95]
    g.MinCrowdPenalty_by_etf = [0.3, 0.3, 0.3]
