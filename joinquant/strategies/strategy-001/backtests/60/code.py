...
JQ_AUTO_AUDIT_TOKEN = 'etf_factor_rotation-gold-crowd-ab-gold-neutralized-20260515205345-a2a305aa'
...
def set_parameter(context):
    ...
    g.CrowdStart_by_etf = [0.6, 0.6, 0.99]
    g.CrowdEnd_by_etf = [0.95, 0.95, 0.999]
