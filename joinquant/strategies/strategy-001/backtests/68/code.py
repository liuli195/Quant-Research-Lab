...
JQ_AUTO_AUDIT_TOKEN = 'etf_factor_rotation-s01-momentum-extreme-worktree-20260517162701-44e5920a'
...
def set_parameter(context):
    ...
    g.MomentumExtremeScoreStart = 0.85
    g.MomentumExtremeTiltCap = 1.0
    g.RSRSTiltMin = 0.70
    g.RSRSTiltMax = 1.30
    g.CrowdWindow = 500
    g.CrowdRetShort = 20
