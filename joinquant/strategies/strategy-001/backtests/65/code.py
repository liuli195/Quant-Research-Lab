...
JQ_AUTO_AUDIT_TOKEN = 'etf_factor_rotation-ai-crowd-ab-ai-calc-longwin-20260515210715-21613e43'
...
def set_parameter(context):
    ...
    g.CrowdRetShort_by_etf = [40, 20, 20]
    g.CrowdRetMid_by_etf = [90, 60, 60]
