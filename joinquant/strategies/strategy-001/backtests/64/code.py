...
JQ_AUTO_AUDIT_TOKEN = 'etf_factor_rotation-ai-crowd-ab-ai-neutralized-20260515210445-51e5fe47'
...
def set_parameter(context):
    ...
    g.CrowdStart_by_etf = [0.99, 0.6, 0.6]
    g.CrowdEnd_by_etf = [0.999, 0.95, 0.95]
